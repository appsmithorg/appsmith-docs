...
You can check the [Query Settings Guide](../core-concepts/connecting-to-data-sources/query-settings.md) to learn more about queries.
...
![Getting BaseID](../.gitbook/assets/baseIDInAPIDocumentation.jpg)
