...
2. [Sharing data across page](../../advanced-concepts/sharing-data-across-pages.md)
3. [Uploading a file to S3](how-to-upload-to-s3.md)
4. [Migrate apps to a new instance](../../advanced-concepts/more/backup-restore.md)
5. [Writing JavaScript in Appsmith](writing-javascript-in-appsmith.md)
6. [Embed Appsmith application into an existing application](../../advanced-concepts/embed-appsmith-into-existing-application.md)
7. [Work with local APIs on Appsmith](../../advanced-concepts/more/how-to-work-with-local-apis-on-appsmith.md)
8. [How to work with Google Sheets on Appsmith](how-to-work-with-google-sheets-on-appsmith.md)
9. [How to implement custom authentication on Appsmith](../../advanced-concepts/how-to-implement-custom-authentication-on-appsmith.md)
