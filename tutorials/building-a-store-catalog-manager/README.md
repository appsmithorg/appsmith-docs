...
You must have an account on either [Appsmith Cloud](https://app.appsmith.com/user/signup) (it's free) or your own[ private instance](https://github.com/appsmithorg/appsmith-docs/blob/v1.3/tutorials/setup/README.md) before getting started. Before diving in, let's talk a bit about the Appsmith environment.
...
{% content-ref url="part-1-creating-a-simple-view.md" %}
[part-1-creating-a-simple-view.md](part-1-creating-a-simple-view.md)
{% endcontent-ref %}
