...
![How to call a function defined in a JS Object?](<../../../.gitbook/assets/JavaScript Editor  Calling JS Object.png>)
...
* Navigate to `Page` >> Select [`Table`](../../../reference/widgets/table.md) widget in Widgets Tab >> Drag it onto the canvas.
...
The [table widget](../../../reference/widgets/table.md) will show the data as shown in the below screenshot.
...
To achieve this, add a new column to the [table widget](../../../reference/widgets/table.md) and select the `Column Type` as an `icon button` type that will open a modal window.
...
![Async Function](<../../../.gitbook/assets/JavaScript Editor  Called only from Event or Trigger.png>)
