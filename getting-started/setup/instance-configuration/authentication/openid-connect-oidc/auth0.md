...
<figure><img src="../../../../../.github/drafts/17478/as_oidc_offline.png" alt=""><figcaption><p>Configure one or more scopes at Appsmith</p></figcaption></figure>

#### What does Appsmith need as part of Scopes?

Appsmith needs **openid** and **email** as mandatory scopes. It's also highly recommended to use the **offline\_access** scope to avoid errors related to expired access tokens and excessive re-login requests.
