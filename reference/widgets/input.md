...
| **Required**        | Sets whether the input is a mandatory field. When the input is within a Form widget, that Form's submit button will be automatically disabled until the input is added by the user.                    |
