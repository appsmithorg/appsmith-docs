...
{% hint style="info" %}
In the beta version of the List widget, you can only use widgets to display the data like image, text, and more. However, the widgets that need users to provide inputs like text box, checkbox, and more, are not available in beta but will be added as part of future releases.
{% endhint %}
...
![How to add a new widget to the list widget?](../.gitbook/assets/List-Widget-Add-widgets-to-first-item.png)
...
| Background Color       | Allows you to choose a background color of the widget.                             | You can select the color from the color pallet or use an HTML color Code by enabling a JS label next to it.                                                                                     |                              |
