...
| **hasChanges** <mark style="color:yellow;">(Coming Soon!)</mark> | It helps you to know if the form has been changed by the application user | Binding    | You can use the property to verify if any fields in the form have been changed.                                                                                                                 | `{{widget_name.hasChanges}}` |
...
{% hint style="info" %}
The **hasChanges** property changes will be Released Soon.
{% endhint %}
