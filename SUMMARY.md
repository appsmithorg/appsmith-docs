...
* [Setup Appsmith](setting-up/README.md)
  * [Docker](setting-up/docker/README.md)
    * [Email](setting-up/docker/email/README.md)
      * [Sendgrid](setting-up/docker/email/sendgrid.md)
      * [Amazon SES](setting-up/docker/email/amazon-ses.md)
    * [Google OAuth](setting-up/docker/google-login.md)
    * [Github OAuth](setting-up/docker/github-login.md)
    * [Google Maps](setting-up/docker/google-maps.md)
  * [AWS AMI](setting-up/aws-ami.md)
  * [Heroku](setting-up/heroku.md)
  * [Telemetry Opt-In](setting-up/telemetry.md)
