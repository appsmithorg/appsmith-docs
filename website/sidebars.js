        ...
        'getting-started/start-building',
        {
          ...
          items: [
              ...
              items: [
                {
                  type: 'category',
                  label: 'Docker',
                  link: {type: 'doc', id: 'getting-started/setup/installation-guides/docker/README'},
                  items: [
            ...
            items: [
              {
                ...
                items: [  
                  ...
                  'getting-started/setup/instance-configuration/authentication/github-login', 
                  {
                    type: 'category',
                    label: 'SAML SSO',
                    link: {type: 'doc', id: 'getting-started/setup/instance-configuration/authentication/security-assertion-markup-language-saml/README'},
                    items: [
                  ...
                  },
                  {
                    ...
                    link: {type: 'doc', id: 'getting-started/setup/instance-configuration/authentication/openid-connect-oidc/README'},
                    items: [
              ...
              },
              {
                type: 'category',
                label: 'Email',
                link: {type: 'doc', id: 'getting-started/setup/instance-configuration/email/README'},
                 items: [
              ...
              'getting-started/setup/instance-configuration/disable-user-signup',
              {
               ...
               link: {type: 'doc', id: 'getting-started/setup/instance-configuration/custom-domain/README'},
                items: [
           ...
           },
           {
            ...
            link: {type: 'doc', id:  'getting-started/setup/instance-management/README'},
            items: [
      ...
      items: [
        {
          ...
          items: [
            'core-concepts/connecting-to-data-sources/connecting-to-databases',
            {
              type: 'category',
              label: 'REST APIs',
              link: {type: 'doc', id:  'core-concepts/connecting-to-data-sources/authentication/README'},
              items: [
                'core-concepts/connecting-to-data-sources/authentication/connect-to-apis',
                {
                  type: 'category',
                  label: 'Authentication Type',
                  link: {type: 'doc', id:  'core-concepts/connecting-to-data-sources/authentication/authentication-type/README'},
                  items: [
                    'core-concepts/connecting-to-data-sources/authentication/authentication-type/basic-authentication',
                    {
                      type: 'category',
                      label: 'OAuth 2.0',
                      link: {type: 'doc', id:  'core-concepts/connecting-to-data-sources/authentication/authentication-type/oauth2-authentication/README'},
                      items: [
          ...
          items: [
            {
              ...
              link: {type: 'doc', id:  'core-concepts/building-ui/designing-an-application/README'},
              items: [
          ...
          items: [
            {
              type: 'category',
              label: 'Queries',
              link: {type: 'doc', id:  'core-concepts/data-access-and-binding/querying-a-database/README'},
              items: [
            ...
            },
            {
              ...
              link: {type: 'doc', id:  'core-concepts/data-access-and-binding/displaying-data-read/README'},
              items: [
            ...
            },
            {
              ...
              link: {type: 'doc', id:  'core-concepts/data-access-and-binding/capturing-data-write/README'},
              items: [
          ...
          items: [
            {
              type: 'category',
              label: 'JS Objects',
              link: {type: 'doc', id:  'core-concepts/writing-code/javascript-editor-beta/README'},
              items: [
        ...
        },
        {
          ...
          items: [
            ...
            'reference/appsmith-framework/query-object',
            {
              type: 'category',
              label: 'Actions',
              link: {type: 'doc', id:  'reference/appsmith-framework/widget-actions/README'},
              items: [
    ...
    { //Learning and Resources start
      ...
      items: [
          ...
          items: [
            {
              ...
              link: {type: 'doc', id:  'learning-and-resources/tutorials/review-moderator-dashboard/README'},
              items: [
            ...
            },
            {
              ...
              link: {type: 'doc', id:  'learning-and-resources/tutorials/building-a-store-catalog-manager/README'},
              items: [
        ...
        },
        {
          type: 'category',
          label: 'How To Guides',
          link: {type: 'doc', id:  'learning-and-resources/how-to-guides/README'},
          items: [
