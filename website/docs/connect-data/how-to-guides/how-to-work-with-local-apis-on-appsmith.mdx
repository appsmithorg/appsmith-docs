...
# Connect Datasource on Local Datasource
...
3. Back in your Appsmith app, [create a datasource](/connect-data/how-to-guides/connect-datasource) for the appropriate type of database or API.
