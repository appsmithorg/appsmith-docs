...
Bearer Tokens are the predominant access token used with [OAuth 2.0](/connect-data/reference/authenticated-api).
...
You can check the [Query Settings Guide ](/connect-data/reference/query-settings) to learn more about queries.
