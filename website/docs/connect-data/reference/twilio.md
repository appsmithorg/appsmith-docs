...
:::note
You can change the [Query settings](/connect-data/reference/query-settings.md) by clicking the **settings** tab.
:::
...
:::note
You can change the [Query settings](/connect-data/reference/query-settings.md) for all the queries by clicking the **settings** tab.
:::
