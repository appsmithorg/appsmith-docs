...
In some cases, like [running a query inside a loop](/learning-and-resources/how-to-guides/how-to-pass-params-to-an-api), parameters may need to be passed to the query with values contextual to the execution.
