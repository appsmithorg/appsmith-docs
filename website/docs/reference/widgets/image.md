...
Sets the maximum allowable zoom level for the image view. 
...
Enables users to control whether the image is allowed to rotate.
...
Enables users to control whether the image is allowed to be downloaded.
