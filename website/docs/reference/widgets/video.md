...
Allows you to set the video source to be played, supporting IP-based URLs with the following components:

* **Protocol:** `https://`
* **Auth:** `username:password@`
* **Hostname or IP:** `www.example.com` or `192.168.0.1`
* **Port:** `:8080` 
* **Path/params:** `/path/to/video.mp4`
