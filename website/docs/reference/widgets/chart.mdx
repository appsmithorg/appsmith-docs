...
## Example 2 - all the details inside the table 

**Add use-case/example/format inside the table description and create a section only if needed.**
...
|         Property         	| Data type 	|                                                                                                          Description                                                                                                          	|
|:------------------------:	|-----------	|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:	|
| **Chart Type**               	| String    	| Sets the type of Chart used to display data. Choose one of the charts from the available options, or create a custom chart (available from FusionCharts). <br/> With the **Chart Type** property, you can select one of the following types to visualize your data: <br/>* Line Chart, <br/>* Bar Chart, <br/>* Pie Chart, <br/>* Column Chart, <br/>* Area Chart, and  <br/>* [Custom Chart](#custom-charts)                                                                    	|
| **Series Title**             	| String    	| Sets the title for the current chart series.                                                                                                                                                                               	|
| **Series Color**             	| String    	| Defines the color for the current chart series, allowing visual customization and differentiation between series.                                                                                                                                                                                 	|
| **Series Data**              	| Array     	| Specifies the data points for the current chart series, providing the values to be plotted on the chart. The series data must be in a [specific format](#display-data). <br/> To display data in the Chart widget, you can use the **Series Data** property to provide the data in the following structure: <br/>`[  {    "x": "Product1",    "y": 20000  },  ...]`<br/><br/>If the data is not in the desired format, you can use JavaScript to transform the data by adding it to the Series Data property.<br/>`{{fetchUserData.data.map( p => ({x: p.gender, y: p.count}))}}`<br/><br/>The code uses the `map()` function to transform each item in the `fetchUserData.data` array into an object with an `x` and a `y` key.                                                                                                                                                                          	|
| **Add Series**              	| Button     	| This feature allows you to populate the chart with different sets of data and customize various aspects of its appearance, such as colors and labels, to create a visually appealing and informative chart.                                                                                                                                                                                    	|
| **Title**                    	| String    	| Sets the text that appears at the top of the chart as a title.                                                                                                                                                                	|
...
## Example 3 - property table first 
...
Explain individual properties and examples.
...
## Content Properties
These properties are present in the property pane of the widget. 

#### Chart Type `String`

  <dd>Sets the type of Chart used to display data. Choose one of the charts from the available options, or create a custom chart (available from FusionCharts).</dd>

#### Series Data `String`

  <dd>Sets the type of Chart used to display data. Choose one of the charts from the available options, or create a custom chart (available from FusionCharts).
    
 Specifies the data points for the current chart series, providing the values to be plotted on the chart. </dd><br />

<dd><i>Example:</i></dd>

<dd>The series data must be in a specific format:</dd>
...
<dd>In this format, <code>x</code>, denotes the label, and <code>y</code> denotes the value.</dd>

<dd>If the data is not in the desired format, you can use JavaScript to transform the data by adding it to the Series Data property.</dd>

<dd><pre>{`{{fetchUserData.data.map( p => ({x: p.gender, y: p.count}))}}
`}</pre></dd>
<dd>The code uses the <code>map()</code> function to transform each item in the fetchUserData.data array into an object with an x and a y key.</dd><br />


#### **Series Color** `String`

  Defines the color for the current chart series, allowing visual customization and differentiation between series.

---
https://loopback.io/doc/en/lb4/LoopBack-types.html

https://stdlib.fortran-lang.org/module/stdlib_ansi.html

https://wechaty.js.org/docs/api/message

https://www.gatsbyjs.com/docs/reference/rendering-options/deferred-static-generation/

https://developers.cloudflare.com/workers/wrangler/configuration/

https://anbox-cloud.io/docs/ref/webrtc-streamer
