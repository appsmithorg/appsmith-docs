...
You can display dynamic data from queries or JS functions by binding the response to the **Series Data** property. If you need to transform the incoming data to match the expected structure, you can use JavaScript code to perform the transformation before binding it to the Chart widget.
...
## Trigger actions on data point selection
