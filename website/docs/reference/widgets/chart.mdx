...
## See also
- [Plot Chart With Filters](/build-apps/how-to-guides/Display-and-filter-chart-data) - Learn how to plot charts and add filters to visualize your data effectively.
- [Create Custom Charts](/build-apps/how-to-guides/create-custom-charts) - See how to create custom charts to suit your app's needs.
- [Monitor App Usage](/build-apps/how-to-guides/usage-app) – See how to monitor app usage and track performance metrics in real-time using Chart widget.
