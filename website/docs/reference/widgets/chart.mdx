...
With multiple series, you can compare the relationships between different sets of data over time, just like in the political election example.  
  ...
  It's commonly used to compare different data points, such as sales figures for different products. With multiple series, you can compare and contrast data across different categories.
