...
* [Custom Fusion Chart](#custom-fusion-chart)
...
:::caution
The support for Custom Fusion Charts ends on March 1st, 2024. Change the chart type to [Custom ECharts](#custom-echarts) to switch.
:::
