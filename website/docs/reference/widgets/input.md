...
| **Show step arrows**              | Control's visibility of step arrows for a number type input. When turned off: The step arrows to increment or decrement the values in the widget is hidden.                                                                        |
