...
<YoutubeEmbed videoId="Rvlwb5123mE" title="How to use Chart Widget" caption="How to use Chart Widget"/>
...
<YoutubeEmbed videoId="YrTtmdephs8" title="How to add a Chart widget to canvas?" caption="How to add a Chart widget to canvas?"/>
...
<YoutubeEmbed videoId="yPLH8bbUth0" title="How to plot a line chart on Appsmith?" caption="How to plot a line chart on Appsmith?"/>
...
<YoutubeEmbed videoId="wp4IHJIynmc" title="How to add series to capture more data points?" caption="How to add series to capture more data points?"/>

Similar to cumulative open, you can also add details for active bugs.

<YoutubeEmbed videoId="5z21ep4moIk" title="How to add data points for active bugs?" caption="How to add data points for active bugs?"/>

In the series data, you can also bind it to fetch the defect data from an API/Query.

<YoutubeEmbed videoId="5z21ep4moIk" title="How to add data points by binding an API response?" caption="How to add data points by binding an API response?"/>
...
<YoutubeEmbed videoId="lLrybSBTb9k" title="A two-dimensional column chart" caption="A two-dimensional column chart"/>
...
<YoutubeEmbed videoId="GVfm9RTuRaE" title="Add a sub caption" caption="Add a sub caption"/>
...
<YoutubeEmbed videoId="M2CLXC3rlMQ" title="Add a number prefix" caption="Add a number prefix"/>
...
<YoutubeEmbed videoId="ITwJOlQnqyI" title="Add trendlines" caption="Add trendlines"/>
...
<YoutubeEmbed videoId="InxEQvwpiSw" title="A Pareto 3D Chart" caption="A Pareto 3D Chart"/>
...
<YoutubeEmbed videoId="232PF7OFSu8" title="A three-dimensional Pie Chart" caption="A three-dimensional Pie Chart"/>
...
<YoutubeEmbed videoId="4nsdEfEJewc" title="A three-dimensional Stacked Column Chart" caption="A three-dimensional Stacked Column Chart"/>
...
<YoutubeEmbed videoId="cnmHBAwZz1g" title="How to use visible property to show/hide a widget" caption="How to use visible property to show/hide a widget"/>
