---
Description: This page provides information on how to use the Audio widget to play MP3 and WAV audio files. It also supports URLs from YouTube, Facebook, Twitch, SoundCloud, Streamable, Vimeo, Wistia, Mixcloud, and DailyMotion. 
---
# Audio
...
Allows you to set the audio source to be played. It supports various formats such as MP3 and WAV. 
