...
Each **Map Type** has different configurations. To learn more about these charts and their specific configurations, you can refer to the [List of Entities](#region-and-country-codes) section.
