...
Firebase saves date and time information in a non-standard _seconds_ format, and
can be quite annoying when using JavaScript. This video explains all you need to
know about accurately converting Firestore timestamps into JavaScript date:

<VideoEmbed host="youtube" videoId="SHrp7cLXr9s" title="How To Convert Firestore Timestamp To JavaScript Date" caption="How To Convert Firestore Timestamp To JavaScript Date"/>
