...
To resolve this error, you must upgrade to the checkpoint version, in this case, `v1.9.2`. You can check this [Checkpoint upgrade guide](/getting-started/setup/instance-management#checkpoint-upgrade) to learn more about checkpoint upgrade. 
