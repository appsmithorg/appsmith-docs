...
If you can't upgrade your infrastructure or can't upgrade your embedded Appsmith MongoDB version:
* You may use an external MongoDB version 5 or higher on [MongoDB Atlas](https://www.mongodb.com/pricing).
* **Or** downgrade your Appsmith instance to v1.8.15. Follow the steps below to downgrade to v1.8.15:
