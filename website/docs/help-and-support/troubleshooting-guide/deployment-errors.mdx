...
To resolve this error, you must [upgrade to the checkpoint version](/getting-started/setup/instance-management/update-appsmith#upgrade-to-checkpoint-version), in this case, `v1.9.2`.
