...
Appsmith, hosted on Azure Web App, cannot connect to a PostgreSQL database (Azure Database for PostgreSQL flexible server). Users receive the error: "" when trying to test the connection.
