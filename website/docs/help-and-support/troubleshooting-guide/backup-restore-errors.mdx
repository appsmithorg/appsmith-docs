...
3. Start Appsmith with Docker-Compose using the `docker-compose.yaml` file in the current directory. Run the below command to start the Appsmith container:
