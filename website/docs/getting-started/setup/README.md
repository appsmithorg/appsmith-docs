...
:::info
Appsmith needs internet access to reach Appsmith cloud services `cs.appsmith.com` for several important features such as templates, Google Sheets integration, and fetching release notes to work. Appsmith provides an **Airgapped version** as part of [Enterprise Plan](https://www.appsmith.com/pricing).
:::
