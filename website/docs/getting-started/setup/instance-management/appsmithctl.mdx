...
<Tabs groupId="appsmithEditions" queryString="current-edition">
  ...
  ```bash
  kubectl cp appsmith-0:/appsmith-stacks/data/backup/appsmith-backup-<Time_stamp>.tar.gz appsmith-backup-<Time_stamp>.tar.gz
  ```
  ...
  :::
  ```bash
  kubectl exec <any-appsmith-pod> appsmithctl backup
  ```

  The archive file is stored in the container directory `/appsmith-stacks/data/backup/`.

  Copy the archive file from any of the appsmith pods
  ```bash
  kubectl cp <any-appsmith-pod>:/appsmith-stacks/data/backup/appsmith-backup-<Time_stamp>.tar.gz appsmith-backup-<Time_stamp>.tar.gz
  ```
  </TabItem>
...
<Tabs groupId="appsmithEditions" queryString="current-edition">
  ...
  Copy the archive file to the pod
  ```bash
  kubectl cp appsmith-backup-<Time_stamp>.tar.gz appsmith-0:/appsmith-stacks/data/backup/
  ```
  Restore
  ...
  Copy the archive file to the pod
  ```bash
  kubectl cp appsmith-backup-<Time_stamp>.tar.gz <any-appsmith-pod>:/appsmith-stacks/data/backup/
  ```
  Restore

  ```bash
  kubectl exec <any-appsmith-pod> appsmithctl restore
  ```
