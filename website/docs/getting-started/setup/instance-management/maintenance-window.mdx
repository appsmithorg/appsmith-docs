...
* [Switch Off Automatic Updates](/getting-started/setup/instance-management/switch-off-automatic-updates) - Learn how to switch off the scheduled automatic updates.