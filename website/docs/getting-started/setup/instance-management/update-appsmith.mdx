...
## AWS ECS EC2
Follow the below steps using the [Classic Amazon Web Console](https://console.aws.amazon.com/ecs/) to manually update Appsmith:
...
6. Click the **Stop** button to stop the task.
7. A new task is deployed automatically.
8. Wait for the new task to be deployed.
9. Verify that the updated version of your application is running as expected.
