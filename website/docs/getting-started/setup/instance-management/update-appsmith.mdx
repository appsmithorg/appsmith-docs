...
1. Upgrade to the checkpoint version if your current version is older than v1.9.2. Refer to the [Upgrade to checkpoint version guide](/getting-started/setup/instance-management/upgrade-to-checkpoint-version).  
