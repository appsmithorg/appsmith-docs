...
- After upgrading, re‑run the image checks above to confirm images reference `docker.io/bitnamilegacy/*`.

## Troubleshooting

If your deployment is down and the pod is still not starting after upgrading, you may need to clear the current broken pod in the StatefulSet. Force a rollout of the MongoDB and PostgreSQL StatefulSets:
