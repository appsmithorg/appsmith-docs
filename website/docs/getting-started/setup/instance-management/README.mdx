...
You may need to manually map your instance to the required version, in this case, ```v1.9.2```. To do this, access your Appsmith instance and make the following change to the `docker-compose.yml` file:
