...
services:
  appsmith:
    image: index.docker.io/appsmith/appsmith-ee:v1.8.5
    container_name: appsmith
  ```
  </TabItem>
</Tabs>
...
```
 docker-compose up -d
```
Your server starts with version 1.8.5 that makes all the necessary schema changes to your Appsmith instance. 
