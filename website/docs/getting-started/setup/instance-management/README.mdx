...
## Checkpoint upgrade
Upgrading a Docker container checkpoint to the latest version is a crucial step in maintaining the stability, security, and performance of the containerized applications. 

You may need to manually map your instance to the required version If your current version of Appsmith is less than `v1.9.2`. To do this, access your Appsmith instance and make the following change to the `docker-compose.yml` file:
