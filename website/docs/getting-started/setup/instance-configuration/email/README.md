...
4. Add the configuration details for your email provider as below: 
    ...
    <dd>Add the username for your email service provider.</dd> <br/>
    <dt><b>SMTP Password</b></dt>
    <dd> Add the password for your email service provider.</dd> 
    </dl>
...
2. Update the values of the environment variables as shown below:
    ...
    <dd> Set it to the username for accessing the SMTP service provider. </dd><br/>
    <dt><b>APPSMITH_MAIL_PASSWORD</b></dt>
    <dd>Set it to your password. </dd>
    </dl>
