---
description: This page provides the steps and guidance for the migrating your external MongoDB Appsmith data to an external PostgreSQL database.
title: External MongoDB to External PostgreSQL
hide_title: true
---
<!-- vale off -->

<div className="tag-wrapper">
 <h1> External MongoDB to External PostgreSQL </h1>

<Tags
tags={[
{ name: "Beta", link: "https://www.appsmith.com/pricing", additionalClass: "neutral" }
]}
/>
</div>
...
- Back up the Appsmith instance to ensure you can revert if necessary. For more information, see the [Backup Appsmith instance](/getting-started/setup/instance-management/backup-and-restore/backup-instance) guide.
...
- Use an existing PostgreSQL instance or set up a new one. For more information on creating a new PostgreSQL instance, see the [How to set up external PostgreSQL](/getting-started/setup/instance-configuration/external-postgresql) guide.
...
* Roll back to the backup you created in the [Prerequisites](#prerequisites) section. For more information, see [Restore Appsmith instance](/getting-started/setup/instance-management/backup-and-restore/restore-instance).
