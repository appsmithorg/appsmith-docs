...
2. Browse the hostname and verify that you can access your Appsmith instance.

3. To set up DNS for your domain name, create a CNAME record for the `LoadBalancer` hostname.
