...
| Name                                                     | Description |
| -------------------------------------------------------- |-------------|
| [applicationConfig.APPSMITH_OAUTH2_GOOGLE_CLIENT_ID](/getting-started/setup/instance-configuration/authentication/google-login)    | Google OAuth2 client ID for authentication |
| [applicationConfig.APPSMITH_OAUTH2_GOOGLE_CLIENT_SECRET](/getting-started/setup/instance-configuration/authentication/google-login) | Google OAuth2 client secret for authentication |
| [applicationConfig.APPSMITH_OAUTH2_GITHUB_CLIENT_ID](/getting-started/setup/instance-configuration/authentication/github-login)     | GitHub OAuth2 client ID for authentication  |
| [applicationConfig.APPSMITH_OAUTH2_GITHUB_CLIENT_SECRET](/getting-started/setup/instance-configuration/authentication/github-login) |GitHub OAuth2 client secret for authentication   |
| applicationConfig.APPSMITH_CLIENT_LOG_LEVEL            | The logging level for the client-side logs  |
| [applicationConfig.APPSMITH_GOOGLE_MAPS_API_KEY](/getting-started/setup/instance-configuration/google-maps)         | Google Maps API key for using Google Maps in the application  |
| [applicationConfig.APPSMITH_MAIL_ENABLED](/getting-started/setup/instance-configuration/email/)                | Enable or disable email capability for your instance  |
| [applicationConfig.APPSMITH_MAIL_HOST](/getting-started/setup/instance-configuration/email/)                   | The email server hostname  |
| [applicationConfig.APPSMITH_MAIL_PORT](/getting-started/setup/instance-configuration/email/)                   | The email server port number  |
| [applicationConfig.APPSMITH_MAIL_USERNAME](/getting-started/setup/instance-configuration/email/)               | The email server username   |
| [applicationConfig.APPSMITH_MAIL_PASSWORD](/getting-started/setup/instance-configuration/email/)               | The email server password  |
| [applicationConfig.APPSMITH_MAIL_FROM](/getting-started/setup/instance-configuration/email/)                   | The email address from which emails are sent  |
| [applicationConfig.APPSMITH_REPLY_TO](/getting-started/setup/instance-configuration/email/)                    | The email address to which replies are sent   |
| [applicationConfig.APPSMITH_MAIL_SMTP_AUTH](/getting-started/setup/instance-configuration/email/)              | Enable or disable SMTP authentication for email  |
| [applicationConfig.APPSMITH_MAIL_SMTP_TLS_ENABLED](/getting-started/setup/instance-configuration/email/)         | Enable or disable TLS for email  |
| [applicationConfig.APPSMITH_DISABLE_TELEMETRY](/product/telemetry#disable-telemetry)           | Disable or enable telemetry  |
| applicationConfig.APPSMITH_RECAPTCHA_ENABLED           | Enable or disable reCAPTCHA |
| applicationConfig.APPSMITH_RECAPTCHA_SITE_KEY          | reCAPTCHA site key for enabling reCAPTCHA  |
| applicationConfig.APPSMITH_RECAPTCHA_SECRET_KEY        | reCAPTCHA secret key for enabling reCAPTCHA  |
| [applicationConfig.APPSMITH_MONGODB_URI](/getting-started/setup/instance-configuration/custom-mongodb-redis#custom-mongodb)                | MongoDB URI for connecting to an external MongoDB database  |
| [applicationConfig.APPSMITH_REDIS_URL](/getting-started/setup/instance-configuration/custom-mongodb-redis#custom-redis)                   |Redis URL for connecting to an external Redis   |
| applicationConfig.APPSMITH_ENCRYPTION_PASSWORD         | Password used for encryption  |
| applicationConfig.APPSMITH_ENCRYPTION_SALT             | Salt used for encryption  |
| [applicationConfig.APPSMITH_CUSTOM_DOMAIN](/getting-started/setup/instance-configuration/custom-domain/#dockerk8s)               | Custom domain for your Appsmith instance  |
