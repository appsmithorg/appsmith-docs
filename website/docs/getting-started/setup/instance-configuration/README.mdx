...
You can modify your Appsmith installation on Kubernetes using Helm parameters or Appsmith environment variables. Use the `helm install` command to configure your Appsmith installation using one of the below ways:
...
* **Or** using Appsmith environmental variables: For example, change the encryption salt configuration with:
