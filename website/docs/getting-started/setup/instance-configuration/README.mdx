...
helm upgrade \
#highlight-next-line
--set applicationConfig.APPSMITH_MAIL_FROM="test@test.com" \
  appsmith appsmith/appsmith 
```
...
1. Update the parameter values in the `values.yaml` file under the `applicationConfig` section:
