...
For incoming release communications that need administrator attention, see [Admin central](/getting-started/setup/instance-configuration/admin-central). That page is informational and is listed under **Instance** in Admin Settings.
