...
<dd>
Enables the **Built on Appsmith** watermark, which appears on the bottom right corner of your app. If you want to remove this watermark, you need an [Appsmith Commercial Edition](https://www.appsmith.com/pricing) plan. If you have already purchased a plan, see the upgrade to the [Appsmith Commercial Edition](/getting-started/setup/manage-editions) guide.
</dd>
...
This is useful for improving security and managing idle users. 
</dd>
...
For more information on how to embed Appsmith, see [Embed Appsmith](/advanced-concepts/embed-appsmith-into-existing-application) guide.
</dd>
