---
description: Follow the steps to upgrade the Appsmith community Docker installation.
---
import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

# Upgrade from Community Appsmith (Docker)
...
- Deployed the latest version of Appsmith. Refer to [Upgrade Appsmith Versions](/getting-started/setup/instance-management/update-appsmith#update-on-docker) to update the version.
