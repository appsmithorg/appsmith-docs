...
## Configuration
You should be able to use Appsmith with default configuration. If you wish you could also configure the installation.
...
In case you haven't installed the Helm chart yet, you can run the below command to install it along with publishing Appsmith:
