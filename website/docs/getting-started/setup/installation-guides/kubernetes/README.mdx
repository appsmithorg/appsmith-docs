...
- Outbound network access to `cs.appsmith.com` for license validation and updates. To verify connectivity after install, see [Verify connectivity to cs.appsmith.com](/help-and-support/troubleshooting-guide/verify-cs-appsmith-connectivity).
