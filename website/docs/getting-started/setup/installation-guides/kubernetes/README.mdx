...
This command installs the Helm chart, enables the ingress controller, and publishes Appsmith on the internet.
  ...
  <TabItem label="Community Edition" value="communityEdition"> 
  Enable the ingress controller through command with:
...
* [Configure TLS](/getting-started/setup/installation-guides/kubernetes/configure-tls)
* [Configure your Instance](/getting-started/setup/instance-configuration)
