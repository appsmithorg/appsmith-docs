...
2. kubectl - This is the command-line interface to manage resources on Kubernetes clusters. To install <Highlighter highlighterClassName="highlightText" content="kubectl"></Highlighter>, follow the instructions for your platform from the official [Kubernetes documentation](https://kubernetes.io/vi/docs/tasks/tools/install-kubectl/).
