...
## Before you begin
1. Installed Helm package manager on your local machine. See the official Helm documentation for your [operation system](https://helm.sh/docs/intro/install/#through-package-managers).
2. A running Kubernetes cluster. If not present, follow these steps to set up the cluster:
...
3. Installed and configured `kubectl` to interact with your Kubernetes cluster. See the official Kubernetes documentation for instructions on how to install `kubectl` on your specific operating system: 
