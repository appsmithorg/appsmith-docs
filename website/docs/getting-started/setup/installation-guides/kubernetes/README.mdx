...
8. To verify the installation locally, use the below command to forward the 8080 port to 80:
...
9. Open [https://localhost](https://localhost) and wait for the server to come up. This can take up to 5 minutes. Once the server is up and running, you can access Appsmith at [https://localhost](https://localhost).
