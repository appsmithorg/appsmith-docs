...
8. Log into your Appsmith account, and enter your license key to activate the instance.
 ...
 If you wish to configure high availability and scalability see [Configure High Availability and Scalability](/getting-started/setup/installation-guides/kubernetes/configure-high-availability) guide.
