...
1. Follow the steps below to configure the Kubernetes cluster:
...
<TabItem label="Minikube" value="Minikube">
  ...
  a. [Setup kubectl](https://minikube.sigs.k8s.io/docs/handbook/kubectl/).

  b. Ensure that you have a default storage class running. If not, [enable addon default-storage class](https://kubernetes.io/docs/tutorials/hello-minikube/#enable-addons).
...
<TabItem label="Microk8s" value="Microk8s">
  ...
  2. Create a folder named `appsmith` on your machine for deployment and data storage. Then, navigate to this folder using the `cd` command and follow the steps below:
  ...
  6. To verify the installation locally, use the below command to forward the 8080 port to 80:
    ...
    kubectl --namespace default port-forward <APPSMITH_POD_NAME> 8080:80
    ```

  7. Open [https://localhost](https://localhost) and wait for the server to come up. This can take up to 5 minutes. Once the server is up and running, you can access Appsmith at [https://localhost](https://localhost).
...
3. Create a folder named `appsmith` on your machine for deployment and data storage. Then, navigate to this folder using the `cd` command and follow the steps below:

4. Add the Appsmith chart repository with:

  ```bash
  helm repo add appsmith-ee https://helm-ee.appsmith.com
  ```
5. Load the Appsmith chart repository with:
...
8. Open [https://localhost](https://localhost) and wait for the server to come up. This can take up to 5 minutes. Once the server is up and running, you can access Appsmith at [https://localhost](https://localhost).
