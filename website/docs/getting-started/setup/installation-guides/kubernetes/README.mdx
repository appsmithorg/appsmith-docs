...
* At least 15 GB of free storage space and 4 GB of RAM.
* Helm Package Manager to install and manage applications on Kubernetes clusters. If you don't have it, copy and run the below command for your operation system to install the Helm package manager:
  - MacOS - `brew install helm`.
  - Debian/Ubuntu-based systems - `sudo apt install -y helm`.
  - Red Hat/Fedora-based systems - `sudo dnf install -y helm`.
  - Windows - `choco install kubernetes-helm`.
* kubectl to manage resources on Kubernetes clusters. If you don't have it, copy and run the below command for your operation system to install kubectl:
  - MacOS - `brew install kubectl`.
  - Debian/Ubuntu-based systems - `sudo apt install -y kubectl`.
  - Red Hat/Fedora-based systems - `sudo dnf install -y kubectl`.
