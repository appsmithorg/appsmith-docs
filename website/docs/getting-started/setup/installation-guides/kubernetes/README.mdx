...
## Configure Appsmith
Appsmith installation works with the default configuration. However, you have an option to customize the installation to fit your specific needs. To configure parameters, we recommend using the `values.yaml` file. The following is a comprehensive list of available parameters that helps you tailor your installation.
