...
## Prerequisites
1. A self-hosted Kubernetes Commercial Edition Appsmith installation. If not installed yet, see the [Kubernetes installation guide](/getting-started/setup/installation-guides/kubernetes) for installing Appsmith.
