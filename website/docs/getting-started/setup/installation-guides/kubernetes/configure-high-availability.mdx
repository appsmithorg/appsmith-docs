...
## Prerequisites
  ...
  2. You can create a backup of the Appsmith instance before a manual update. For more information, see [Backup Appsmith Instance](/getting-started/setup/instance-management/appsmithctl?current-command-type=backup-kubernetes-commands&current-edition=businessEdition#backup-appsmith-instance) (_Recommended_)
...
## Troubleshooting
If you see deployment errors, you can roll back to a previous version to fix the issue. For more information, see the [Restore Appsmith instance](/getting-started/setup/instance-management/appsmithctl?current-command-type=restore-kubernetes-commands&current-edition=businessEdition#restore-appsmith-instance) section. 
