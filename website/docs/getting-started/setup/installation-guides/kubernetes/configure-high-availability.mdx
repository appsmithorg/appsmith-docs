...
<div className="tag-wrapper">
 <h1> High Availability and Scalability (k8s)</h1>
...
1. A self-hosted Appsmith Commercial Edition installation on a Kubernetes cluster. If not installed yet, see the [Kubernetes installation guide](/getting-started/setup/installation-guides/kubernetes) for installing Appsmith.
