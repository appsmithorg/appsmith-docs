...
2. You may choose to configure external managed PostgreSQL, MongoDB, and Redis instances for your self-hosted instance. Follow these steps to configure an external managed PostgreSQL, MongoDB, and Redis instances:
  ...
  * Update the below parameters to point to an external managed PostgreSQL:
  
    ```yaml
    # configure an external managed PostgreSQL
    applicationConfig:
...
* Update the below parameters to point to an external managed MongoDB:
...
* Update the below parameters to point to an external managed Redis:
