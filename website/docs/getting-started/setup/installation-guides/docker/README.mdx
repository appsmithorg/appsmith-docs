...
* If you are manually updating the Appsmith instance and your current version of Appsmith is less than `v1.9.2`,  make sure that you [upgrade to the checkpoint](/getting-started/setup/instance-management#checkpoint-upgrade) version `v1.9.2` released between your version and the latest version.
:::
