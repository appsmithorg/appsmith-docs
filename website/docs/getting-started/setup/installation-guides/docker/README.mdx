...
5. If you have a license key, enter it to activate your instance to try the paid plan.  If you don't have a license key and want one, sign up on [customer.appsmith.com](https://customer.appsmith.com), generate a license key, and then activate your instance.
