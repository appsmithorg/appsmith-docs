...
:::
   ...
   1. Sign up on [customer.appsmith.com](http://customer.appsmith.com/) and generate a trial license key.

   2. Click to download the [`docker-compose.yml`](https://bit.ly/docker-compose-business) file, and place it into the Appsmith installation folder.
