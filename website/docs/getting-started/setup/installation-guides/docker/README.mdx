...
3. Add the **license key** (`APPSMITH_LICENSE_KEY`) to the `environment:` key in the `docker-compose.yml` file.
...
If this is the first time starting up using Docker, there will be a welcome page similar to the one below.
