...
* When you are manually updating the Appsmith instance, ensure that you [upgrade to the checkpoint](/getting-started/setup/instance-management#checkpoint-upgrade) version `v1.9.2` released between your version and the latest version.
:::
