...
10. Scroll up to configure the Appsmith container.
    ...
    2. In the **STANDARD** section, provide details as below:
    ...
    3. Click the **Advanced container configuration**, and add details as below:
    ...
    5. Click **Add** button. You will see the container name available under **Container definitions**.
