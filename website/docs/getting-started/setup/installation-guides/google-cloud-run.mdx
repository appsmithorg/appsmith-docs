...
- An external MongoDB instance for Appsmith data storage - It's recommended to use [MongoDB Atlas](https://www.mongodb.com/atlas/database).
...
Follow these steps to install Appsmith Community on Google Cloud Run:
