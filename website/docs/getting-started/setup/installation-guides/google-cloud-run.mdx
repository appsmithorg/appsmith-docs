...
3. In the form, select **Deploy one revision from an existing container image**.
    - In the **Container image URL**, enter:
       - For *Community Editio* - `docker.io/appsmith/appsmith-ce`.
...
13. Click the **Logs** tab to verify everything works fine. Wait a few minutes until you see the message `Appsmith is running` in the logs.
