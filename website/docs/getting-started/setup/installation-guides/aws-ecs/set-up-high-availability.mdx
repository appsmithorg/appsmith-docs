...
1. Take a backup of your existing MongoDB instance before proceeding.
...
10. Restore your Appsmith Redis backup you took earlier to the new Redis instance. For more information, see the [Redis backup](getting-started/setup/instance-management/appsmithctl#backup-database) guide.
...
- If you continue facing issues, contact support using the chat widget available at the bottom-right corner of this page.
