...
- An Appsmith Commercial Edition installation using AWS ECS on Fargate. If not installed yet, see the [AWS ECS on Fargate](https://docs.appsmith.com/getting-started/setup/installation-guides/aws-ecs-on-fargate) installation guides for installing Appsmith.
