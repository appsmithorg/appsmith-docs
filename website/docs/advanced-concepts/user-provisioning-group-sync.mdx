...
4. Go to the **Overview** page on the sidebar, and click to **start provisioning** button on the navigation bar.
...
4. Go to the **Push Groups** tab, click on the **+ Push Groups** dropdown and select **Find Group by name**.
    ...
    a. Enter the group name you want To sync group memberships from Okta to your application.
