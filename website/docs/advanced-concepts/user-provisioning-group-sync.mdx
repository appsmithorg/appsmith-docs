...
3. Go to the **Provisioning** tab, click **Edit** on SCIM connection.
    ...
    a. Paste the **SCIM API endpoint** URL that you copied in step 3 under the [Enable SCIM provisioning](/advanced-concepts/user-provisioning-group-sync#enable-scim-provisioning-on-appsmith) section to the **SCIM connector base URL** field.
    ...
    e. In the **HTTP Header** section, paste the **API key** that you copied in step 4 under the [Enable SCIM provisioning](/advanced-concepts/user-provisioning-group-sync#enable-scim-provisioning-on-appsmith) section to the **Authorization** field.
