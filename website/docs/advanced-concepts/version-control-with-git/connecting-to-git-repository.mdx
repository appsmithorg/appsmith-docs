...
:::info
For self-hosted instances, to maintain the Git repositories, please [update the local file path](/advanced-concepts/version-control-with-git/updating-local-file-path).
:::
