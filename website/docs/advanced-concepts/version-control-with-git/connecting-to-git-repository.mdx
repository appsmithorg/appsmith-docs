...
:::info
A user needs to have `Create` permission for the workspace to be able to connect or disconnect an app to Git. This permission can be shared through Workspace Admin and Developer roles or through custom roles using granular access control.
:::
