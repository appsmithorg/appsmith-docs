...
#### General notes
1. Renaming a resource is the same as deleting the old resoruce and creating a new one in the Git file system. For ex, when you rename a query, you may see `2 queries modified` while trying to commit, the 2 changes are the old query being deleted and the new one being created.
