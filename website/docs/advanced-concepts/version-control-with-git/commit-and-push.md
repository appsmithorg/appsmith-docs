...
In the deploy window, enter your commit message and click on `Commit and Push` to update your repository with the latest changes. The author of the commit is tagged to the user committing changes on Appsmith.
