...
<Tabs queryString="gac-resource">
  ...
  <TabItem label="Workflows" value="workflows">
    <table>
      <thead>
        <tr>
          <th>Resource</th>
  ...
  <TabItem label="Groups & Roles" value="groups-and-roles">
    <table>
      <thead>
        <tr>
          <th>Resource</th>
  ...
  <TabItem label="Others" value="others">
    <table>
      <thead>
        <tr>
          <th>Resource</th>
...
The **Create** permission determines which resources users are permitted to create within the Appsmith instance. Depending on the resource to which the permission is assigned, it will have cascading effects on child resources, inheriting the same permissions.

### Cascading permissions

Below is a summary of the cascading permissions associated with the **Create** permission for different resource categories:

| Resource         | Cascading Permissions       |
|------------------|-----------------------------|
| Workspace        | Edit, View, Delete, Execute |
| Application      | Edit, View, Delete, Execute |
| Page             | Edit, View, Delete, Execute |
| Datasources      | Edit, View, Delete, Execute |
| Datasource       | Edit, View, Delete, Execute |
| Environments     | Edit, View, Delete, Execute |
| Environment      | Edit, View, Delete, Execute |
| Workflows        | Edit, Delete                 |
| Groups           | Edit, View, Delete, Invite User, Remove User |
| Roles            | Edit, View, Delete, Associate Role         |
| Custom Roles     | Edit, View, Delete, Associate Role         |
| Workspaces       | NA                                      |

### Permissions impact

Below is a summary of the permissions impact associated with the **Create** permission for different resource categories:
  ...
  <TabItem label="Application Resources" value="application-resources">
    <table>
      ...
      <tbody>
        ...
        <tr>
          <td><b>Application</b></td>
          <td>Allows creating, editing, viewing, and deleting pages and queries within the application. It also permits running queries within the given application.</td>
        </tr>
        <tr>
          <td><b>Page</b></td>
          <td>Allows creating, editing, viewing, deleting, and running queries within the given application.</td>
