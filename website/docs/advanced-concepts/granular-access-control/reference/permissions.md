---
description: >-
  Permissions in Granular Access Control
title: Permissions
hide_title: true
---
<!-- vale off -->
...
This category governs access privileges to workspaces and applications built in Appsmith, such as apps, pages or queries. 
...
| Permission | Automatically assigns |  Description | 
|------------|-------------|--------------|
