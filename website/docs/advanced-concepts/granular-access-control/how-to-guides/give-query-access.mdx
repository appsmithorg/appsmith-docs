...
- Enabled the Programmatic Access Control feature. For more information, see [Programmatic Access Control](/getting-started/setup/instance-configuration/configure-instance-1). 
