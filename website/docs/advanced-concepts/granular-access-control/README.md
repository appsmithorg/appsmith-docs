...
To enable Access Control using code - 
1. Go to **Admin Settings > General** and under **Programmatic access control** select the **Access roles and user groups in code for conditional business logic** checkbox.
