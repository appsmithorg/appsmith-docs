...
1. What workflows are, how they automate tasks, and their structure and components.
...
6. Click the **Deploy** button to save and publish your workflow.
...
4. Click the **Deploy** button to apply these settings.
...
3. Set the Request Method and URL as shown below:
   - **Method**: Set to `POST`.
   - **URL**: Enter the webhook URL you copied earlier in the [Configure webhook trigger](#configure-webhook-trigger) section.
...
6. Verify the response generated by the workflow. You will see a response similar to the one below, indicating the workflow has started successfully. Check your inbox for an email from `demo.smtp.send.email@gmail.com`.
