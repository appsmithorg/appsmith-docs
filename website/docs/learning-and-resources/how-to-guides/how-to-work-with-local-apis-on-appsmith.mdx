...
This page shows three methods:

* _(Recommended):_ To connect to your local datasource via a self-hosted _or_ Cloud Appsmith instance is to expose the datasource via **ngrok**, which you can read about in the **ngrok** tab below.

* _(Alternative):_ If you're self-hosting Appsmith and you're connecting to a datasource on `localhost`, you can follow the steps in the **Datasource on localhost** tab below.

* _(Alternative):_ If you're self-hosting Appsmith and you're connecting to a datasource in a Docker container, you can follow the steps in the **Datasource in Docker** tab below.
...
<TabItem label="Datasource on localhost" value="localhost">
...
<TabItem label="Datasource in Docker" value="docker">
