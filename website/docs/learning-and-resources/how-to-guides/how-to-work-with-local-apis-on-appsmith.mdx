...
The recommended way to connect to your local datasource is to expose it via **ngrok**, which you can read about in the **ngrok** tab below. If you're self-hosting your Appsmith instance and you'd like to connect another way, you can follow the steps in the **localhost** tab if your datasource is hosted via localhost, or the **Docker datasource** tab if it's in its own Docker container.
...
<TabItem label="Docker datasource" value="docker">
