...
Look through the following options to see which guide suits your situation:

* When you're self-hosting Appsmith and your local datasource is hosted via `localhost`, follow the steps in the **localhost** tab of [Self-hosted Appsmith](#self-hosted-appsmith) below.
* When you're self-hosting Appsmith and your local datasource is in a Docker container, follow the steps in the **Datasource in Docker** tab of [Self-hosted Appsmith](#self-hosted-appsmith) below to set up a Docker network.
* If you're connecting from the Appsmith Cloud platform to your locally hosted datasource, follow the steps in [Appsmith Cloud](#appsmith-cloud) to set up ngrok.
