...
There are different steps depending on your setup:
* [Connect self-hosted Appsmith to localhost datasource](#self-host-to-localhost-datasource)
* [Connect self-hosted Appsmith to Docker datasource](#self-host-to-docker-datasource?docker-method=docker-network)
* [Connect cloud Appsmith to any local datasource](#cloud-to-local-datasource)
...
<TabItem label="Docker network" value="docker-network">


### Datasource in Docker
