...
![Elastic-1](</img/Elastic_-_1_(1).png>)
...
![Elastic-3](</img/Elastic-3_(1).png>)
...
![Elastic-5](/img/Elastic-5.png)

Drag and drop it on the canvas. It should be like this.

![Elastic-6](/img/Elastic-6.png)
...
![Elastic-9](</img/Elastic_9_(1).png>)
...
![Elastic-11](</img/Elastic_11.png>) ![Elastic-12](</img/Elastic_12.png>)
...
![Elastic-1-gif](</img/Elastic_-_1_gif.gif>)
...
![Elastic-16](</img/Elastic_16.png>)

Let's update one of the values to check if our application is working.

![Elastic-2-gif](</img/Elastic_-_2_gif_(1)_(1)_(1)_(2)_(1)_(1)_(1)_(1)_(1)_(3)_(3)_(3)_(4).gif>)
