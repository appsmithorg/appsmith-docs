...
Now let's display all the reviews in the [list view](/reference/widgets/list). List widget provides you with out-of-the-box functionality to iterate over a structured data collection. The datasets can be static or generated by the response from API/queries.
