...
You can also make the application public. In that case, anyone with the URL to the application can view the application without signing in. You can read more about [share application](/advanced-concepts/share-application).
