...
2. In your Appsmith app, create a [datasource](/data/datasource-reference) for the appropriate type of database or API.
...
3. Back in your Appsmith app, create a [datasource](/data/datasource-reference) for the appropriate type of database or API.
