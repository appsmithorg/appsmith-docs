...
<YoutubeEmbed videoId="YXo4PVrw1RQ" title="Reactive" caption="Reactive" />
...
<YoutubeEmbed videoId="yKb6SRonfmQ" title="Controlling Widgets with code" caption="Controlling Widgets with code" />
