...
<YoutubeEmbed videoId="tpbY5Jti9d4" title="How to build with JS Editor" caption="How to build with JS Editor" />
...
<YoutubeEmbed videoId="8kzyYaHnwPw" title="How to add a JS Object?" caption="How to add a JS Object?" />
...
JavaScript Editor is an extensive editor that provides additional functionalities while writing code. You can do a lot with it, like:
 ...
 <YoutubeEmbed videoId="agyvQNFGGIY" title="A quick walkthrough of JavaScript Editor" caption="A quick walkthrough of JavaScript Editor"/>
...
:::
 ...
 <YoutubeEmbed videoId="ZjleR7iM-xo" title="How to use Debugger" caption="How to use Debugger"/>
...
* In the `Property Pane` on right side add the code `{{Utils.getAllDeveloperTaskStatus()}}` in `Table Data` property.
 ...
 <YoutubeEmbed videoId="HJGOf5ez4eY" /> 
...
```
 ...
 <YoutubeEmbed videoId="cuoUVqzhCMo" /> 
