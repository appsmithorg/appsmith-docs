...
This event defines the action that would be executed when the user selects or deselects item in the Radio Group. It allows you to specify a list of [actions](/write-code/reference/widget-actions) that can be triggered in response to the widget state change.
