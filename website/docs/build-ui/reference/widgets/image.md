...
Alternatively, you can use the built-in [Download](/write-code/reference/widget-actions/download) function and set it to run on the [**onClick**](#onclick) event of the Image widget as shown below:
...
When the event is triggered, these event handlers can execute queries, JS code, or other supported [actions](/write-code/reference/widget-actions).
