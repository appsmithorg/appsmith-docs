...
![How to call a function defined in a JS Object?](<../../.gitbook/assets/call\_JS\_object (1) (1) (1) (1).png>)
...
* Navigate to `Page` >> Select [`Table`](../../widget-reference/table/) widget in Widgets Tab >> Drag it onto the canvas.
...
To achieve this, add a new column to the [table](../../widget-reference/table/) widget and select the `Column Type` as an `icon button` type that will open a modal window.
